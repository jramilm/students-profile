...
<div class="content">
    <div class="flex">
          <h2 style="width:30%">Town/City Records</h2>
    ...
    <table class="orange-theme">
        ...
        foreach ($results as $result) {
            ...
            <tr>
                ...
                <td>
                    <a href="town_edit.php?id=<?php echo $result['id']; ?>"><i style="font-size:24px;color:forestgreen" class="fa fa-edit"></i></a>
                    |
                    <a href="town_delete.php?id=<?php echo $result['id']; ?>"><i style="font-size:24px;color:orangered" class="fa fa-trash"></i></a>
                </td>
            </tr>
        <?php } ?>
